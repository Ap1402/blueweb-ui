      ...
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          bank: Yup.string().required(
            "Es necesario seleccionar el banco desde el cual hizo el pago"
          ),
          amount: Yup.string().required(
            "Es necesario ingresar el monto del pago"
          ),
            ...
            <div className="row ">
              ...
              <div className="col-10 mx-auto">
                <SelectField label="Banco emisor" name="bank">
                  ...
                  <option value="BANCO EXTERIOR C.A.">
                    BANCO EXTERIOR C.A.
                  </option>
              ...
              <div className="col-10 mx-auto">
                <SelectField label="Banco destinatario" name="bankDestiny">
                  <option value="">Seleccione un banco</option>
                  {destinationBanks.map((destinationBank) => {
                    return (
                      <option value={destinationBank.id}>
